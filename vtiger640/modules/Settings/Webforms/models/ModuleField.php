...
class Settings_Webforms_ModuleField_Model extends Vtiger_Field_Model {
	...
	public function getFieldInfo() {
		...
		if($this->getFieldDataType() == 'currency') {
			...
			// danzi.tn@20170104 Validation Error $fieldInfo['decimalSeperator'] = $currentUser->get('currency_decimal_separator');
			$fieldInfo['decimalSeparator'] = $currentUser->get('currency_decimal_separator');
			// danzi.tn@20170104 Validation Error $fieldInfo['groupSeperator'] = $currentUser->get('currency_grouping_separator');
