...
class Countries_DashBoard_Model extends Vtiger_DashBoard_Model {
	/**
	...
	public function getDefaultWidgets() {
		...
		$widgets[] = array(
			'contentType' => 'json',
			'title' => 'Countries to be verified',
			'mode' => 'open',
			'url' => 'module='. $moduleModel->getName().'&view=ShowWidget&mode=getTbvCountries'
		);
