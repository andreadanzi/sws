	...
	<body>
		<div class="container-fluid login-container">
			<div class="row-fluid">
				...
				<!-- danzi.tn@20150831 rimozione helpLinks
				<div class="span9">
					<div class="helpLinks">
				...
				<div class="span12">
					<div class="content-wrapper">
						<div class="container-fluid">
							<div class="row-fluid">
								<div class="span6">
    								<!-- danzi.tn@20150831 rimozione carousal
								...
								<div class="span6">
									<div class="login-area">
										<div class="login-box" id="loginDiv">
											<div class="">
												<h3 class="login-header">Login to SWS CRM</h3>
		</div>
			...
			<div class="control-group">
				...
				<div class="controls">
												...
												<!-- danzi.tn@20150831 remove stats
				...
				<div class="container-fluid">
					<div class="row-fluid">
						...
						<div class="span6 pull-right" >
    						<!-- danzi.tn@20150831 rimozione social
